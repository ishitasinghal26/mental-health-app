          ...
          <div style={{ position: "relative" }}>
            ...
            {menuOpen && (
              <div style={dropdown}>
                ...
                <Link to="/profile" style={dropdownItem} onClick={() => setMenuOpen(false)}>
                  ⚙️ Profile & Settings
                </Link>
                <button style={dropdownItemBtn} onClick={handleLogout}>
                  🚪 Sign out
                </button>
              </div>
            )}
...
const modePillAI: React.CSSProperties = {
  background: "#eef2ff",
  color: "#4338ca",
};

const modePillPrivate: React.CSSProperties = {
  background: "#f0fdf4",
  color: "#065f46",
};
